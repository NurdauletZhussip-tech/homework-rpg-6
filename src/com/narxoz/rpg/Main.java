...
public class Main {
    public static void main(String[] args) {
        ...
        ArenaFighter hero = new ArenaFighter("Эвклид", 135, 0.15, 25, 10, 30, 7);
        ArenaOpponent opponent = new ArenaOpponent("Никола Тесла", 100, 21);
        ...
        ArenaFighter tournamentHero = new ArenaFighter("Ньютон", 135, 0.25, 30, 10, 67, 1);
        ArenaOpponent tournamentOpponent = new ArenaOpponent("Пифагор", 120, 52);
